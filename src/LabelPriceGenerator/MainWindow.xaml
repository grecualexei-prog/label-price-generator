<Window x:Class="LabelPriceGenerator.MainWindow"
        ...
        Title="Generator de etichete de pret" Height="780" Width="1200" WindowStartupLocation="CenterScreen">
    <Grid Margin="12">
        ...
        <TextBlock Grid.Row="0" Grid.Column="0" Grid.ColumnSpan="2" Text="Generator de etichete de pret" FontSize="26" FontWeight="Bold" Margin="0,0,0,12"/>
        ...
        <GroupBox Grid.Row="1" Grid.Column="0" Header="Produse" Margin="0,0,10,0">
            <Grid>
                ...
                <DataGrid x:Name="ProductGrid" AutoGenerateColumns="False" IsReadOnly="True" SelectionMode="Single" Margin="8" AlternatingRowBackground="#F7F9FB">
                    <DataGrid.Columns>
                ...
                <StackPanel Grid.Row="1" Orientation="Horizontal" HorizontalAlignment="Right" Margin="8">
                    ...
                    <Button x:Name="ImportCsvButton" Content="Import CSV" Width="120"/>
                    <Button x:Name="ExportCsvButton" Content="Export CSV" Width="120"/>
                </StackPanel>
            </Grid>
        </GroupBox>
